...
import { X, ChevronLeft, ChevronRight, MapPin, FileText, Sparkles, Bell, CheckCircle, Briefcase, Users, Building2, TrendingUp } from 'lucide-react'
...
export function OnboardingModal({ userType, isOpen, onComplete }: OnboardingModalProps) {
